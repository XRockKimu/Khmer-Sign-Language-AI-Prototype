...
-- (tables, constraints, indexes) -- it does not include seed data, which
-- lives in the numbered seed migrations and should be applied separately
-- after this file. Use migrations/ for the ordered, authoritative change
-- history; use this file to stand up a fresh database in one step or as a
-- quick reference for the current shape of the schema.
--
